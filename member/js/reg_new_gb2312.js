...
$(document).ready(function(){
	...
	$("#txtUsername").change( function() {
		...
		data: "dopost=checkuser&fmdo=user&lang=gb2312&cktype=1&uid="+$("#txtUsername").val(),
		dataType: 'html',
	...
	$("#uname").change( function() {
		$.ajax({type: reMethod,url: "index_do.php",
		data: "dopost=checkuser&fmdo=user&lang=gb2312&cktype=0&uid="+$("#uname").val(),
		dataType: 'html',
	...
	$("#email").change( function() {
		...
		if(!sEmail.exec($("#email").val()))
		{
			...
			$.ajax({type: reMethod,url: "index_do.php",
			data: "dopost=checkmail&fmdo=user&lang=gb2312&email="+$("#email").val(),
			dataType: 'html',
