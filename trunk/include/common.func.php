...
function GetLang($rsid, $lang='')
{
	...
	$lang = preg_replace("/[^0-9a-z_]/i", '', $lang);
...
function ShowMsg($msg,$gourl='',$onlymsg=0,$limittime=0)
{
	...
	else
	{
      ...
      function JumpUrl(){
		...
		$rmsg .= "<div style='padding:6px;font-size:12px;border-bottom:1px solid #D1DDAA;background:#DBEEBD url({$GLOBALS['cfg_phpurl']}/img/wbg.gif)';'><b>DEDECMS Message!</b></div>\");\r\n";
